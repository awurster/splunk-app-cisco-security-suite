...
sigs = open(os.path.join(os.environ["SPLUNK_HOME"], 'etc','apps','cisco','bin','data','ips_sigs') ).readlines()

## Define output log
log_out = open(os.path.join(os.environ["SPLUNK_HOME"], 'etc','apps','cisco','logs','ips_sdee.log.ips.secure.acme'),'w')
