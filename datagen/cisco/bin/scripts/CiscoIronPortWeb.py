...
log_sample  = open(os.path.join(os.environ["SPLUNK_HOME"], 'etc','apps','cisco','bin','data','cisco_wsa.log'),'r').readlines()


## Define output log
log_out = open(os.path.join(os.environ["SPLUNK_HOME"], 'etc','apps','cisco','logs','ironport_web.log'),'w')
